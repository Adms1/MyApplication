...
public class CurrentScheduleAdapterItem {
	int wu_avail;
	...
	ArrayList<String> PreReqID, Abbr, PreReqChecked, LevelName, LevelID,INSTRUCTORNAME,INSTRUCTORID;

	public CurrentScheduleAdapterItem(int wu_avail, String existSwimComp,
			...
			ArrayList<String> levelID,ArrayList<String> INSTRUCTORNAME,
			ArrayList<String> INSTRUCTORID) {
		super();
