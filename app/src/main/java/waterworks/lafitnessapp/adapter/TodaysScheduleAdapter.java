...
//										}
                                                if (newprereqid.get(j).toString().contains("_")) {
                                                    String[] splitStr = newprereqid.get(j).toString().split("\\_");
                                                    prereqid.add(splitStr[1]);
                                                }else{
                                                    prereqid.add(newprereqid.get(j).toString());
                                                }
                                            }
                                        }
                                    }
