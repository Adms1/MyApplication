...
public class ViewCurrentScheduleFragment extends Fragment implements
    ...
    public static ArrayList<String> IScheduleID = new ArrayList<String>();
    public static ArrayList<String> InstructorID = new ArrayList<String>();
    public static ArrayList<String> InstructorName = new ArrayList<String>();
    public static ArrayList<String> InstructorID1= new ArrayList<String>();
    public static ArrayList<String> InstructorName1 = new ArrayList<String>();
                   ...
                   InstructorName1.clear();
                    for (int k = 0; k < jArray.length(); k++) {
                        ...
                        for (int i = 0; i < jArray2.length(); i++) {
                            ...
                            InstructorID1.add(jsonObject2
                                    .getString("InstructorID"));
                            InstructorName1.add(jsonObject2.getString("InstructorName"));
...
//							btn_send_review.setVisibility(View.VISIBLE);
                            for (int i = 0; i < SAge.size(); i++) {
                                att_Items.add(new ViewCurrentScheduleAdapterItem(
                                                wu_avail, ExistSwimComp.get(i),
                                                IsShowSmCampStatus.get(i), att
                                                .get(i),
                                                wu_attendancetaken.get(i),
                                                ISAAlert.get(i), SScheduleID.get(i), IScheduleID.get(i),
                                                 InstructorID1
                                                .get(i), InstructorName1
                                                .get(i), lessontypeid
                                                .get(i), SAge.get(i),
                                                SLevel.get(i),
